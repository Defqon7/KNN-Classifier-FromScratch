"""
KNN Classifier for video game preference classification
...
if __name__ == '__main__':
    ...
    parser.add_argument('--predict', required=True, nargs=4, type=float, help='4 floating point inputs for predicting '
                                                                              'video game preference: age (in years), '
                                                                              'height (in inches), weight (in lbs), '
                                                                              'and gender (females represented by 0s '
                                                                              'and males represented by 1s)')
